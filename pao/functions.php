...
//------------------подключение шрифтов------------------
  function wph_add_google_fonts() {
      if ( !is_admin() ) {
          wp_register_style('Open+Sans', 'https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800&display=swap&subset=cyrillic,cyrillic-ext', array(), null, 'all');
...
//------------------Register Custom Post Проекты----------------------
    function project_post_type() {
        $labels = array(
            ...
            'all_items'             => __( 'Проекты', 'text_domain' ),
